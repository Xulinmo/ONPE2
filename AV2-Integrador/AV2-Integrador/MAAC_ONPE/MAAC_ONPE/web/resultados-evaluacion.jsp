...
<%
    ...
    try (Connection cn = Conexion.conectar()) {
        ...
        while(rs.next()){
            ...
            if("Aprobado".equals(est)) aprobados = rs.getInt("total");
            else if("Observado".equals(est)) observados = rs.getInt("total");
            else if("Rechazado".equals(est) || "Desaprobado".equals(est)) rechazados = rs.getInt("total");
        }
