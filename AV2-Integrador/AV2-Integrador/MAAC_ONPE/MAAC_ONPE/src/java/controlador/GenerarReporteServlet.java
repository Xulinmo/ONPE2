...
public class GenerarReporteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Obtenemos el usuario de la sesión para la auditoría (Req. 43)
        ...
        try {
            ...
            documento.add(firma);
            // --- 5. REGISTRO DE AUDITORÍA DE EXPORTACIÓN (Requerimiento 43) ---
            // Este bloque asegura la trazabilidad solicitada en la Vista 3 
            ...
            if (user != null) {
                try (java.sql.Connection cn = modelo.Conexion.conectar()) {
                    ...
                    psLog.setString(2, "Reporte_Aprobados_ONPE.pdf"); // El nombre_archivo que pide tu 2FN
                    psLog.executeUpdate();
                } catch (Exception e) {
